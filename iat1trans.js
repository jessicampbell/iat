	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			category1 : {
				name : 'Cisgender', //Will appear in the data and in the default feedback message.
				title : {
			...
			category2 :	{
				name : 'Transgender', //Will appear in the data and in the default feedback message.
				title : {
